...
<div class="btn-group pull-right">
    <a href="<?= base_url('admin/transaksi/cetak/' . $header_transaksi->kode_transaksi) ?>" target="_blank"
        title="Cetak" class="btn btn-success btn-sm"><i class="fa fa-print"></i> Cetak</a>
    <a href="<?= base_url('admin/transaksi') ?>" title="Kembali" class="btn btn-info btn-sm"><i
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>: <?= $header_transaksi->nama_bank ?> No. Rekening <?= $header_transaksi->rekening_pembayaran ?> a.n
